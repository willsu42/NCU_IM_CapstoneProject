...
public class inno2Activity extends AppCompatActivity {
    int day ;
    double price;
    double count;
    int date;
    ...
    public void initGraph(final GraphView graph, final int counter) {
        final CollectionReference ref = db.collection("innolux");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inno2);
        ...
        t32.setText(Double.toString(stockprice[1]));
        TextView t20 = findViewById(R.id.textView20);
        t20.setText(Double.toString(stockhave[1]));
    ...
    private View.OnClickListener subm = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(getApplicationContext(), everydayActivity.class);
    ...
    private View.OnClickListener sell = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            double sp2 = stockprice[1] -n1*1000*Double.parseDouble(t11.getText().toString());
